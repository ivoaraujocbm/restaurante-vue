<template>
  ...
  <div class="min-h-full">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                :key="item.name" 
                :to="{name: item.name}" 
                class="[item.current ? 'bg-primaryDark text-white' : 'text-white hover:bg-primaryDark hover:text-gray-200', 'rounded-md px-3 py-2 text-sm font-medium']" 
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 bg-background">
        <!-- Your content -->
      </div>
    </main>
  </div>
